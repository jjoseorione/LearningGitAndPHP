...
<html lang="es-mx">
    ...
    <body>
        <div class="divfondo">
            ...
            <p>
                Para poder utilizar el resultado de la consulta utilizaremos una nueva función:
                <div class="code">
                    <em>$reg</em> = mysqli_fetch_array(<em>$regs</em>);
                </div>
                Donde <em>$regs</em> es la variable donde se guardó la referencia a la consulta (la resultante de mysqli_query()) y <em>$reg</em> es la variable donde se guarda cada uno de los registros, uno a la vez (en forma de arreglo de cadenas y con la ayuda de un ciclo while). Cuando se han leído todos los registros resultantes de la consulta, devuelve NULL 
            </p>

    	    <h2>Ejemplo</h2>
    	    <p>
                El siguiente programa muestra en una tabla la información de todos los usuarios registrados.
                <div class="divcodigo">
                    <?php
                        $archivo = htmlentities(file_get_contents('./selectExe.php'));
                        echo "<pre>";
                        echo $archivo;
                        echo "</pre>";
                    ?>
                ...
                <a href="selectExe.php" class="abotonR">Ejecutar ejemplo</a>
            </p>
